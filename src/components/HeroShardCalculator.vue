  ...
  <Container>
    ...
    <div class="py-4 grid grid-cols-1 md:grid-cols-3 gap-2">
      ...
      <InputGroup label="Enter current star (e.g, 5.1)" id="current-star" type="number" v-model="stars.start"
        :number-options="{ step: 0.1, min: 0, max: 15 }" />
      <InputGroup label="Enter your wanted star (e.g, 15)" id="wanted-star" type="number" v-model="stars.end"
        :number-options="{ step: 0.1, min: 0, max: 15 }" />
      <div class="md:col-span-3 bg-white p-4 rounded shadow grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div class="flex justify-center gap-4 md:col-span-3">
